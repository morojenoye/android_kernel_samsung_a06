...
#ifndef _SC1301CSMIPI_SENSOR_H
#define _SC1301CSMIPI_SENSOR_H
...
#define SC1301CS_SENSOR_GAIN_BASE             0x400
#define SC1301CS_SENSOR_GAIN_MAX              (635 * SC1301CS_SENSOR_GAIN_BASE / 10)
#define SC1301CS_SENSOR_GAIN_MAP_SIZE  6
