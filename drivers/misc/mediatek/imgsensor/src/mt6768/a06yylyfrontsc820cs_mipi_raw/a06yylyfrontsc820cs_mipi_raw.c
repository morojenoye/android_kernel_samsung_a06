 ...
 * Filename:
 * ---------
 *	 a06yylyfrontsc820cs_mipi_raw.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "a06yylyfrontsc820cs_mipi_raw.h"

#define PFX "a06yylyfrontsc820cs_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = A06YYLYFRONTSC820CS_SENSOR_ID,
...
UINT32 A06YYLYFRONTSC820CS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
