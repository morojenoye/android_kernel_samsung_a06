...
#include "a0602wxdepthc2519_mipi_raw.h"


/* a06 code for SR-AL7160A-01-543 by liugang at 20240416 start */
/****************************Modify Following Strings for Debug****************************/
#define PFX "A0602WXDEPTHC2519_MIPI_RAW_camera_sensor"
#define LOG_1 LOG_INF("A0602WXDEPTHC2519, MIPI 1LANE\n")
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = A0602WXDEPTHC2519_SENSOR_ID ,
...
static void set_shutter_frame_length(kal_uint16 shutter, kal_uint16 frame_length)
{
	...
	write_cmos_sensor(0x0202, (shutter >> 8) & 0xFF);
	write_cmos_sensor(0x0203, (shutter) & 0xFF);
	LOG_INF("[lj c2519] shutter =%d, framelength =%d/%d, dummy_line=%d, realtime_fps=%d \n", shutter,
		imgsensor.frame_length, frame_length, dummy_line, realtime_fps);
}
//-bug 720367 qinduilin.wt, add, 2022/03/03, modify for dualcam sync
/*************************************************************************
* FUNCTION
...
#define AGAIN_NUM	49
	...
	{ 
	  0x4c, 0x4c,	0x4c,	0x4c,	0x4c,	0x4c,	0x4c,	0x4c,	0x4c,	0x4c,	0x4c,	0x4e,	0x4d,	0x4d,	0x4d,	0x4c,	0x4e,	0x4e,	0x4e,	
	  0x4e,	0x3e,	0x3e,	0x3e,	0x3e,	0x3e,	0x3e,	0x3d,	0x3d,	0x2d,	0x2d,	0x2c,	0x2d,	0x4d,	0x4d,	0x4d,	0x4d,	0x3c,	0x3d,	
	  0x3c,	0x3d,	0x3d,	0x3d,	0x3e,	0x3e,	0x2e,	0x2e,	0x2d,	0x2d,	0x2f,	
	};
	...
	{ 
	  ...
	  0xaf,	0xaf,	0xaf,	0xaf,	0xaf,	0xaf,	0xaf,	0xaf,	0xaf,	0xbf,	0xbf,	0xb0,	0xb0,	0xb0,	0xb0,	0xb0,	0xb0,	0xb0,	0xb0,	
...
static void sensor_init(void)
{
     ...
     write_cmos_sensor(0x3280,0x2b);
     write_cmos_sensor(0x3284,0xA3);
     write_cmos_sensor(0x3288,0x30);
     write_cmos_sensor(0x328b,0x6d);
     write_cmos_sensor(0x328C,0x48);
     write_cmos_sensor(0x32aa,0x04);
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = ((read_cmos_sensor(0x0000) << 8) | read_cmos_sensor(0x0001));
            ...
            printk("[lj c2519]c2519dep_mipi_mono get_imgsensor_id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
