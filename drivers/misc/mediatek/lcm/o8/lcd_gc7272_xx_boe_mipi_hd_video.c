...
#define LCM_ID_GC7272_BOE 0x90

/* A06 code for AL7160A-4117 by huangyin at 20240914 start*/
#define BACKLIGHT_MAX_REG_VAL   (4095*40)
#define BACKLIGHT_MAX_APP_VAL   (255*46)
/* A06 code for AL7160A-4117 by huangyin at 20240914 end*/
...
static struct LCM_setting_table init_setting_cmd[] =
{
    ...
    {0xEF,1,{0x03}},//V03
    {0x29,1,{0x03}},
    {0x01,16,{0x00,0x24,0x00,0x33,0x00,0x52,0x00,0x70,0x00,0x86,0x00,0x9c,0x00,0xb0,0x00,0xc0}},
    {0x02,16,{0x00,0xcf,0x01,0x00,0x01,0x24,0x01,0x56,0x01,0x82,0x01,0xca,0x02,0x04,0x02,0x06}},
    {0x03,16,{0x02,0x47,0x02,0x96,0x02,0xc7,0x03,0x06,0x03,0x30,0x03,0x62,0x03,0x70,0x03,0x80}},
    {0x04,12,{0x03,0x92,0x03,0xa1,0x03,0xb9,0x03,0xd3,0x03,0xef,0x03,0xFF}},
    {0x0D,16,{0x00,0x24,0x00,0x33,0x00,0x52,0x00,0x70,0x00,0x86,0x00,0x9c,0x00,0xb0,0x00,0xc0}},
    {0x0E,16,{0x00,0xcf,0x01,0x00,0x01,0x24,0x01,0x56,0x01,0x82,0x01,0xca,0x02,0x04,0x02,0x06}},
    {0x0F,16,{0x02,0x47,0x02,0x96,0x02,0xc7,0x03,0x06,0x03,0x30,0x03,0x62,0x03,0x70,0x03,0x80}},
    {0x10,12,{0x03,0x92,0x03,0xa1,0x03,0xb9,0x03,0xd3,0x03,0xef,0x03,0xFF}},
...
static void lcm_init(void)
{
    ...
    LCM_LOGI("gc7272_xx_boe----tps6132----lcm mode = vdo mode :%d----\n",lcm_dsi_mode);
}
...
{
    LCM_LOGI("%s,gc7272_xx_boe backlight: level = %d\n", __func__, level);

    if (level == 0) {
        pr_notice("[LCM],gc7272_xx_boe backlight off, diming disable first\n");
        push_table(NULL,
...
struct LCM_DRIVER lcd_gc7272_xx_boe_mipi_hd_video_lcm_drv = {
